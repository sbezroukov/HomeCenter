...
- Для MODE: Open с ответами — разделитель `---`, строка `Ответы:`, затем пронумерованные ответы
...
6. **Test:** варианты с `*` у правильного. **Open:** при необходимости — секция `---` и `Ответы:` с нумерацией.
7. **Кодировка:** UTF-8.
