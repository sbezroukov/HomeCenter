...
# Правило для HomeCenter на порту 8080
New-NetFirewallRule -DisplayName "HomeCenter HTTP 8080" -Direction Inbound -LocalPort 8080 -Protocol TCP -Action Allow -ErrorAction SilentlyContinue
